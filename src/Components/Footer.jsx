    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <ul className="social-media">
          ...
          <li>
            <a
              href="https://www.instagram.com/7express_Service/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.facebook.com/7expressservices"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <div className="footer-bottom">
        ...
        <p>
          ...
          <span className="highlight">7Express</span> Services Sdn Bhd. All
          rights reserved.
        </p>
      </div>
    </footer>
